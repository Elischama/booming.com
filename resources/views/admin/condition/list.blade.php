...
@section('content')
    <div class="panel-content">
        ...
        <div class="main-content-area">
            ...
            <p>[<a href="{{ route('produit.list') }}">Tout</a>] @foreach($categories as $category)[ <a href="{{ route('produit.bycat', $category->id) }}">{{ $category->libelle }}</a> ] @endforeach</p>
                    ...
                    <ul>
                        ...
                        <li style="margin-bottom: 1em;">
                            <div class="cart-thumb">
                                ...
                                <h3><a href="javascript:void(0)" title="">{{ $data->name }}</a></h3>
                            ...
                            <div class="c-input-number">
                                ...
                                <span>Categorie : <strong>{{ $data->category_produit->libelle }}</strong></span><br>
                                @if($data->statut == 1)
                            ...
                            <div class="cart-item-quantity">
                                <a style="color: orange;" href="{{ route('produit.edit', $data->id) }}"><i class="fa fa-edit"></i> Modifier</a><br>
                                <a onclick="return confirm('Cette action est irréversible. Supprimer ?');" style="color: red;" href="{{ route('produit.delete', $data->id) }}"><i class="fa fa-trash"></i> Supprimer</a><br>
                                @if($data->statut == 1)
                                    <a style="color: blue;" href="{{ route('produit.desable', $data->id) }}"><i class="fa fa-close"></i> Desactiver</a>
                                @else
                                    <a style="color: green;" href="{{ route('produit.enable', $data->id) }}"><i class="fa fa-check"></i> Activer</a>
                                @endif
                            </div>
                        </li>
                        @endforeach

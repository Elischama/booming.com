                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            {!! Form::text('name', stripslashes($data->name), ['class' => 'form-control', 'placeholder' => 'ex: Infinix Note 5', 'required']) !!}
                            @if ($errors->has('name'))
                    ...
                    <div class="col-sm-offset-4 col-sm-2">
                        <img class="img-thumbnail tool" src="{{ asset('produits/'. $data->picture_one) }}" title="{{ stripslashes($data->name) }} image n°1" alt="{{ stripslashes($data->name) }} image n°1">
                    </div>
                    <div class="col-sm-2"><img class="img-thumbnail tool" src="{{ asset('produits/'. $data->picture_two) }}" title="{{ stripslashes($data->name) }} image n°2" alt="{{ stripslashes($data->name) }} image n°2"></div>
